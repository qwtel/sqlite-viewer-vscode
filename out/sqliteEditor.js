...
class SQLiteEditorProvider {
    ...
    static register(context) {
        ...
        // });
        return vscode.window.registerCustomEditorProvider(SQLiteEditorProvider.viewType, new SQLiteEditorProvider(context), {
    ...
    async getHtmlForWebview(webview) {
        const files = [
            ...
            return [s, webview.asWebviewUri(vscode.Uri.joinPath(this._context.extensionUri, 'app', s))];
        });
        let html = `
      <!DOCTYPE html>
      <html>
...
SQLiteEditorProvider.newPawDrawFileId = 1;
SQLiteEditorProvider.viewType = 'sqlite.view';
/**
 * Tracks all webviews.
 */
...
//# sourceMappingURL=sqliteEditor.js.map